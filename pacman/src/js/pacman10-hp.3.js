 ...
 * 
 * HTML5声音功能由 张晓雷(zhangxiaolei@outlook.com) 制作
 * 
 */
...
function () {
  ...
  g.prepareElement = function (b, c, d) {
    ...
    if (g.useCss) {
      b.style.backgroundImage = "url(pacman/src/pacman10-hp-sprite-2.png)";
      b.style.backgroundPosition = -c + "px " + -d + "px";
      b.style.backgroundRepeat = "no-repeat"
    } else {
      b.style.overflow = "hidden";
      c = "display: block; position: relative; left: " + -c + "px; top: " + -d + "px";
      b.innerHTML = '<img style="' + c + '" src="pacman/src/pacman10-hp-sprite-2.png">'
    }
  };
  ...
  g.createKillScreenElement = function (b, c, d, f, h) {
    ...
    j.style.zIndex = 119;
    if (h) {
      j.style.background = "url(pacman/src/pacman10-hp-sprite-2.png) -" + g.killScreenTileX + "px -" + g.killScreenTileY + "px no-repeat";
      g.killScreenTileY += 8
  ...
  g.prepareGraphics = function () {
    g.graphicsReady = e;
    g.preloadImage("pacman/src/pacman10-hp-sprite-2.png")
  };
  ...
  g.flashReady = function () {
    g.flashSoundPlayer = {
      playTrack: function (n) {
        gameSound.playTrack(n);
      },
      playAmbientTrack: function (n) {
        gameSound.playAmbientTrack(n);
      },
